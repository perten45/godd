...
PORT=27300
UUID=2e99f4b3-a778-408f-9f58-0acd8159767a
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/perten45/
godd /main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/perten45/
godd /main/etc/xray.json
